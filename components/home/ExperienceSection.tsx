    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto px-8 pt-32 pb-20 border-b border-surface-border/20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-6 lg:pb-2">
            <Reveal delay={0.16}>
              <p className="text-content-primary/40 text-lg leading-relaxed max-w-xl font-body">
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto">
        {pillars.map((pillar, i) => (
          <Reveal key={pillar.number} delay={(i + 1) * 0.08}>
            <div className="group grid grid-cols-1 md:grid-cols-12 gap-0 border-b border-surface-border/20 hover:bg-surface-subtle transition-colors duration-500 cursor-default">
              {/* Number */}
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto px-8 py-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-t border-surface-border/20">
        <Reveal className="text-content-primary/30 text-sm uppercase tracking-[0.2em] font-label">
          Ready to begin?
        </Reveal>
        <Reveal delay={0.08}>
          <a
            href="/contact"
            className="group flex items-center gap-4 text-content-primary hover:text-accent transition-colors duration-300"
          >
